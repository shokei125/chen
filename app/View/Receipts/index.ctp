<div class="receipts index">
	...
	<tr>
		...
		<td><?php echo h($receipt['Receipt']['type']); ?>&nbsp;</td>
		<td><?php echo h($receipt['Receipt']['card_number']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $receipt['Receipt']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $receipt['Receipt']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
